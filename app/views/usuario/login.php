<?php
// Mantenemos la variable por si se necesita en lógica interna, 
// pero en este diseño standalone definimos la estructura HTML completa aquí.
            ...
            <div class="col-lg-6">
                <div class="card1 pb-5">
                    ...
                    <div class="row px-3 justify-content-center mt-4 mb-5 border-line">
                        <img src="https://i.ibb.co/gZDqNpXC/Gemini-Generated-Image-zdc47izdc47izdc4.png" class="image">
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="card2 card border-0 px-4 py-5">
                    <!-- Redes Sociales (Decorativo por ahora) 
                    ...
                    <!-- Mensajes de Error / Éxito de PHP integrados aquí -->
                    <div class="row px-3">
                        ...
                        <?php endif; ?>
                        <?php if (isset($_GET['exito']) && $_GET['exito'] == 'registro_completo'): ?>
                    ...
                    <form action="index.php?controller=Usuario&action=autenticar" method="POST">
                        <div class="row px-3">
                            ...
                            <!-- Cambiado name="email" a name="correo" para coincidir con tu backend -->
                            <input class="mb-4" type="email" name="correo" placeholder="Enter a valid email address" required>
                        </div>
                        <div class="row px-3">
                            <label class="mb-1"><h6 class="mb-0 text-sm">Contraseña</h6></label>
                            <!-- Cambiado name="password" a name="contrasena" para coincidir con tu backend -->
